...
class Animal{
    constructor(species, name, age, service, owner, contact, attitude, health, payment){
...
const pet0= new Animal("aligator", "Smiles", 20,"Jeff", "Nails", "888-888-8888", "hungry", "alive","cash");
const pet1= new Animal("dog", "Roger", 12,"Clarence","Hair", "888-888-8888", "good", "alive","credit");
const pet2= new Animal("cat", "Rachel", 8,"Trey","Surgery", "888-888-8888", "bad", "dead","credit");
const pet3= new Animal("squirrel", "Henry", 6,"Romeo","Dental", "888-888-8888", "great", "alive","cash");
const pet4= new Animal("skunk", "Waddles", 8,"Samantha","Surgery", "888-888-8888", "stinky", "dead","credit");
